...
const body = [
  ...
  ...layers([
    ...
    { label: 'Knowledge', fill: PAL.skill, boxes: ['Steering (always loaded)\ngovernance · migration · redshift · iceberg · schema · informatica-etl · security · project', 'Skills (loaded on demand)\nassessment · sql-conversion · redshift · iceberg · reporting · informatica · schema-conformance · change-propagation', 'MCP (optional)\nPostgreSQL · SQL Server · AWS Knowledge · AWS Docs'] },
    { label: 'Tools', fill: PAL.tool, boxes: ['Skill tools\nassess · redshift · iceberg · schema · change · infa_sql_tool', 'Test engine\npgtest.sh · lib/*.sql · coverage', 'migkit\nsecurity · audit · localdb · services'] },
    { label: 'Data', fill: PAL.data, boxes: ['source/  generated/\nT-SQL · XML · PL/pgSQL', 'Aurora PostgreSQL 17 test DB (IAM)\nRedshift · Athena / Glue (test, when configured)', 'logs/\naudit · state (lineage) · archive'] },
