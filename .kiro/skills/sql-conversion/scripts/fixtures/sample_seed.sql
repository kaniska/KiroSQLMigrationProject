-- ============================================================
-- File: .kiro/skills/sql-conversion/scripts/fixtures/sample_seed.sql
-- Description: Deterministic data for the skill sample schema.
...
-- Loaded by: scripts/selftest.sql
-- ============================================================
