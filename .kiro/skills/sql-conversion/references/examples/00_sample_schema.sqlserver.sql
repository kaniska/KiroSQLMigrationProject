-- ============================================================
-- Skill sample database — SQL Server side (T-SQL DDL)
-- File: .kiro/skills/sql-conversion/references/examples/00_sample_schema.sqlserver.sql
-- Databases: SalesDB + InventoryDB
-- Description: The tables every worked example (01–17) reads or writes.
--              Illustrative only — your own project supplies its own DDL.
...
-- Converted equivalent: 00_sample_schema.postgres.sql
-- ============================================================
...
-- ------------------------------------------------------------
-- Audit (used by the trigger worked example 17)
-- ------------------------------------------------------------
CREATE TABLE [dbo].[OrderStatusAudit] (
    ...
    ChangedAt  DATETIME2         NOT NULL CONSTRAINT DF_OrderStatusAudit_ChangedAt DEFAULT SYSDATETIME()
);
GO
